...
plot_smooth(simulation3.gam.ar, view="time", cond=list(frequency=10, vowel.ord = "BET"),
            rug=F, col="red")
plot_smooth(simulation3.gam.ar, view="time", cond=list(frequency=50, vowel.ord = "BET"),
            rug=F, col="blue", add=T)
plot_smooth(simulation3.gam.ar, view="time", cond=list(frequency=90, vowel.ord = "BET"),
            rug=F, col="green", add=T)
```
