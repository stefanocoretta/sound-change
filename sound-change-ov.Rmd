...
contrasts(change3$word.ord) <- "contr.treatment"
...
```{r}
plot_smooth(simulation2.gam.ar, view="time", cond=list(frequency=10, vowel.ord = "BAT"),
            rug=F, col="red")
plot_smooth(simulation2.gam.ar, view="time", cond=list(frequency=40, vowel.ord = "BAT"),
            rug=F, col="blue", add=T)
plot_smooth(simulation2.gam.ar, view="time", cond=list(frequency=80, vowel.ord = "BAT"),
            rug=F, col="green", add=T)
#plot_smooth(simulation3.gam.ar, view="time", cond=list(frequency=120, vowel.ord = "BAT"),
