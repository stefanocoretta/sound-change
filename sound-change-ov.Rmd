...
plot_smooth(simulation1.gam, view="time", cond=list(frequency=10, vowel.ord = "BAT"),
            rug=F, col="red")
plot_smooth(simulation1.gam, view="time", cond=list(frequency=50, vowel.ord = "BAT"),
            rug=F, col="blue", add=T)
plot_smooth(simulation1.gam, view="time", cond=list(frequency=80, vowel.ord = "BAT"),
