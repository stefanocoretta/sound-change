...
```{r vowel-bin-plots}
graphics <- list(xlab("Iterations"), ylab("Mean F1"), scale_color_discrete(name = "Frequency bins"), theme(legend.position = "top"))
ggsave(plot_1 + graphics, filename = "plot_1.pdf", path = fig_path, width = 7, height = 3)
ggsave(plot_2 + graphics, filename = "plot_2.pdf", path = fig_path, width = 7, height = 3)
ggsave(plot_3 + graphics, filename = "plot_3.pdf", path = fig_path, width = 7, height = 3)
ggsave(plot_4 + graphics, filename = "plot_4.pdf", path = fig_path, width = 7, height = 3)
```
