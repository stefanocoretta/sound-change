...
```{r change5-smooths-BIT}
plot_smooth(simulation5.gam.ar, view="time", cond=list(frequency=10, vowel.ord = "BIT"),
            rug=F, col="red")
plot_smooth(simulation5.gam.ar, view="time", cond=list(frequency=40, vowel.ord = "BIT"),
            rug=F, col="blue", add=T)
plot_smooth(simulation5.gam.ar, view="time", cond=list(frequency=80, vowel.ord = "BIT"),
            rug=F, col="green", add=T)
```
